...
public:
    ...
    void setAssociatedComponent(Component* associatedComponentToUse)
    {
        associatedComponent = associatedComponentToUse;
    }
...
void FileBasedDocument::setAssociatedComponent(Component* associatedComponent)
{
    pimpl->setAssociatedComponent(associatedComponent);
}
